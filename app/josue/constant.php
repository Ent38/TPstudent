...
class constPath
{
    ...
    const CourseImage  = '/josue/assets/courses/images/';
    const UserImage  = '/josue/assets/users/images/';
    const EventImage  = '/josue/assets/events/images/';
    const SystemLogo  = '/josue/assets/system/logos/';
    const NewsImage  = '/josue/assets/news/images/';
    const CategoryImage  = '/josue/assets/categories/images/';
    const LessonImage  = '/josue/assets/lessons/images/';
    const SliderImage  = '/josue/assets/sliders/images/';
    const DefaultImage  = '/josue/placeholder.png';
}
